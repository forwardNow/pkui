...
define("dialog-config", {
    ...
    innerHTML:
        '<div i="dialog" class="pkui-dialog">'
        +       '<div class="pkui-dialog-arrow-a"></div>'
        +       '<div class="pkui-dialog-arrow-b"></div>'
        +       '<table class="pkui-dialog-grid">'
        +           '<tr>'
        ...
        +           '</tr>'
        +           '<tr>'
        +               '<td i="body" class="pkui-dialog-body">'
        +                   '<div i="content" class="pkui-dialog-content"></div>'
        +               '</td>'
        +           '</tr>'
        +           '<tr>'
        +               '<td i="footer" class="pkui-dialog-footer">'
        +                   '<div i="statusbar" class="pkui-dialog-statusbar"></div>'
        +                   '<div i="button" class="pkui-dialog-button"></div>'
        +               '</td>'
        +           '</tr>'
        +       '</table>'
        +'</div>'
...
$.extend(prototype, {
    ...
    title: function (text) {
        ...
        // FIX 标题设置 jquery.text( title ) => jquery.html( text )
...
return dialog;
    ...
    // FIX 添加 seajs 支持
    var pkuiDialog = require("dialog-plus");

    window.pkuiDialog = pkuiDialog;
