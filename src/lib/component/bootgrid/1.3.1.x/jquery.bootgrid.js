...
+function ( $, window ) {
    ...
    $.extend( Grid.defaults, {
        ...
        css: {
            ...
            dropDownItem: "pkui-grid-dropDownItem", // must be a unique class name or constellation of class names within the actionDropDown,
            dropDownItemButton: "pkui-grid-dropDownItemButton", // must be a unique class name or constellation of class names within the actionDropDown
            dropDownItemCheckbox: "pkui-grid-dropDownItemCheckbox", // must be a unique class name or constellation of class names within the actionDropDown
            dropDownMenu: "dropdown btn-group", // must be a unique class name or constellation of class names within the actionDropDown
            dropDownMenuItems: "dropdown-menu pull-right", // must be a unique class name or constellation of class names within the actionDropDown
            dropDownMenuText: "dropdown-text", // must be a unique class name or constellation of class names within the actionDropDown
            footer: "pkui-grid-footer",
            header: "pkui-grid-header",
            icon: "pkui-grid-icon fa",
            iconColumns: "fa-bars",
            iconDown: "fa-sort-down",
            iconRefresh: "fa-refresh",
            iconSearch: "fa-search",
            iconUp: "fa-sort-up",
            infos: "pkui-grid-infos", // must be a unique class name or constellation of class names within the header and footer,
            left: "text-left",
            pagination: "pkui-grid-pagination", // must be a unique class name or constellation of class names within the header and footer
            paginationButton: "pkui-grid-paginationButton", // must be a unique class name or constellation of class names within the pagination
            ...
            right: "text-right",
            search: "pkui-grid-search", // must be a unique class name or constellation of class names within the header and footer
            searchField: "pkui-grid-searchField",
            selectBox: "pkui-grid-selectBox", // must be a unique class name or constellation of class names within the entire table
            selectCell: "pkui-grid-selectCell", // must be a unique class name or constellation of class names within the entire table
        ...
        labels: {
            all: "所有",
            infos: "显示 {{ctx.start}} - {{ctx.end}}， 共 {{ctx.total}} 条",
            loading: "加载...",
            noResults: "没有数据!",
            refresh: "刷新",
            search: "搜索"
    ...
    function _getOredCriteria( queryFormSelector ) {
        ...
        if ( ! queryFormSelector ) {
            return oredCriteria;
        }

        oredCriteria.push( criteriaList );

        $form = $( queryFormSelector );
