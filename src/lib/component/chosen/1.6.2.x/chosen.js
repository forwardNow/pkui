...
define(function( require ) {
  ...
  AbstractChosen.default_multiple_text = "请选择（多选）";

  AbstractChosen.default_single_text = "请选择（单选）";

  AbstractChosen.default_no_result_text = "没有相匹配的结果";

  //
  window.PKUI.component.chosen = $.fn.chosen;

  // FIX 添加字典支持
  function supportPkuDic ( $select, options ) {
      var
          dataList,
